...
<body>
    ...
    QrCode::format('png')->merge('public/frontend/images/tien.png', 0.3, true)->backgroundColor(255, 255, 0)->color(255, 0, 127)->size(500)->errorCorrection('H')->generate('Thanks, ' . Auth::user()->email . ' https://www.facebook.com/hquocdai2304/'),
) !!}  "
                                style="width: 150px; height:150px">
                        @else
                            <img src="data:image/png;base64, {!! base64_encode(
    QrCode::format('png')->merge('public/frontend/images/tien.png', 0.3, true)->backgroundColor(255, 255, 0)->color(255, 0, 127)->size(500)->errorCorrection('H')->generate('Welcome to  https://www.facebook.com/hquocdai2304/'),
) !!}  "
                                style="width: 150px; height:150px">
                        @endif
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-3">
                        ...
                        <ul class="list-unstyled contact-info">
                            <li><i class="icon icon-location"></i>
                                <address>18 phố viên - đức thắng - từ liêm - Hà Nội .</address>
                            </li>
                            <li><i class="icon icon-email"></i><a class="txt" href="#">dai.hoang668@gmail.com</a></li>
                            <li><i class="icon icon-phone"></i><a class="txt" href="#">(00)-0392815432</a></li>
                            <li><i class="icon icon-printer"></i><a class="txt" href="#">(00)-0392815432</a></li>
                        </ul>
                    </div>
